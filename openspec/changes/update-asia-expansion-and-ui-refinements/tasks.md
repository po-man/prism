...
- [x] 4.1 In `layouts/_default/single.html`: Update the `s88_id` reference to `registration_id` if it is rendered anywhere in the header.
- [x] 4.2 In `layouts/partials/itn-scorecard.html`:
...
- [x] 4.3 In `layouts/partials/impact-pathway.html`:
...
- [x] 4.4 In `layouts/partials/myth-buster.html`:
...
- [x] 4.5 In `layouts/partials/audit-checklist.html`:
