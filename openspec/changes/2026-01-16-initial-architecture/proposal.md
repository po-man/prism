...
## Summary
Establish the foundational directory structure and architectural boundaries for the CharityGrader project. This change implements a monorepo pattern that strictly separates orchestration logic (n8n), data schemas, persistent storage, and the presentation layer.
