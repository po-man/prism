...
- [x] 2.1 Build a horizontal flexbox/grid flowchart component in `single.html`.
- [x] 2.2 Map `financials.data.expenditure.total` to the **Inputs** node.
- [x] 2.3 Map `tractability_factors.significant_events` summaries to the **Activities/Outputs** node.
- [x] 2.4 Map `problem_profile.severity_dimensions` to the **Outcomes** node.
