...
def check_remuneration(record: OrganisationRecord) -> AuditCheckItem:
    ...
    if not record.governance or not record.governance.governance or not record.governance.governance.remuneration_disclosure or record.governance.governance.remuneration_disclosure.source_document_present is None:
        base_item.details.calculation = "Governance data for remuneration report is missing."
        return base_item

    if record.governance.governance.remuneration_disclosure.source_document_present:
